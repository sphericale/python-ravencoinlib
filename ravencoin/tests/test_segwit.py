# Copyright (C) 2016 The python-ravencoinlib developers
#
...
from ravencoin.core.script import *
...
class Test_Segwit(unittest.TestCase):
    ...
    def test_p2wpkh_signaturehash(self):
        ...
        address = CBech32RavencoinAddress.from_scriptPubKey(scriptpubkey)
    ...
    def test_p2sh_p2wpkh_signaturehash(self):
        ...
        address = CBase58RavencoinAddress.from_scriptPubKey(redeemscript)
        self.assertEqual(SignatureHash(address.to_redeemScript(), CTransaction.deserialize(unsigned_tx),
    ...
    def test_checkblock(self):
        # (No witness) coinbase generated by Ravencoin Core
        ...
        commitment_script = ravencoin.core.WITNESS_COINBASE_SCRIPTPUBKEY_MAGIC + commitment
